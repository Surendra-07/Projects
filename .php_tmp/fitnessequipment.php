      ...
      <center>
        <div class="wrapper">
          ...
          <div id="buttons">
              ...
              <!-- <button class="button-value" onclick="filterProduct('Under250')">
                Under 250
              </button> -->
              <button class="button-value" onclick="filterProduct('Under300')">
                Under 300
              </button>
              <button class="button-value" onclick="filterProduct('Under350')">
                Under 350
              </button>
              <button class="button-value" onclick="filterProduct('Under400')">
                Under 400
              </button>
