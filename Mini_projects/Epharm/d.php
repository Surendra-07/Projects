            ...
            <div class = "product-div">
                <div class = "product-div-left">
                    <div class = "img-container">
                        <img src = "Healthcare\Gluco bload monetering system\dr-morepen-bg-03-glucometer-test-strips-box-of-25-1-1654168049.webp" alt = "watch">
                    </div>
                    <div class = "hover-container">
                        
                        <div><img src = "Healthcare\Gluco bload monetering system\dr-morepen-bg-03-glucometer-test-strips-box-of-25-1-1654168049.webp"></div>
                        <div><img src = "Healthcare\Gluco bload monetering system\dr-morepen-bg-03-glucometer-test-strips-box-of-25-2-1654168092.webp"></div>
                        <div><img src = "Healthcare\Gluco bload monetering system\dr-morepen-bg-03-glucometer-test-strips-box-of-25-3-1654168021.webp"></div>
                        <div><img src = "Healthcare\Gluco bload monetering system\dr-morepen-bg-03-glucometer-test-strips-box-of-25-6.1-1641787811.webp"></div>
                        <div><img src = "Healthcare\Gluco bload monetering system\dr-morepen-bg-03-glucometer-test-strips-box-of-25-2-1654168092.webp"></div>
                    </div>
                </div>
                <div class = "product-div-right">
                    <span class = "product-name">Gluco monitor</span>
                    <span class = "product-price">₹ 449.25</span>
                    ...
                    <p class = "product-description">Dr Morepen BG03 Glucometer Test Strips when used with Dr Morepen Gluco One BG03 provides fast and accurate blood sugar levels. It is a reliable and convenient method for keeping track of one’s blood sugar. It can be used both professionally in clinics or personally at homes.
                    </p>
                    <br>
                    <p class = "product-description">
                        <ul class="product-description">
                        <h4>Benefits of Gluco Monitor</h4>
                        
                        <li>Helps provide necessary information on how one’s treatment program is affecting their blood glucose level</li>
                       <li>Provides a way to monitor blood glucose anytime and anywhere</li> 
                        <!-- <li>If you have kidney or liver function problems or disease.</li> -->
                    ...
                    <p class="product-description">
                        ...
                        <span>Each strip is for single use only</span>
                        <span>Dispose of used strips properly</span>
