            ...
            <div class = "product-div">
                <div class = "product-div-left">
                    <div class = "img-container">
                        <img src = "Saridon\ftsmbwoi0gmmxgluxdn4.webp" alt = "watch">
                    </div>
                    <div class = "hover-container">
                        <div><img src = "Saridon\ftsmbwoi0gmmxgluxdn4.webp"></div>
                        <div><img src = "Saridon\lrz62fvh5qwcvljqnicg.webp"></div>
                        <div><img src = "Saridon\otyo4sdkupmhvlnqqmmf.webp"></div>
                        <div><img src = "Saridon\saridon-headache-relief-tablet.webp"></div>
                        <div><img src = "Saridon\wstftuqoqzkslhdw4p9r.webp"></div>
                    </div>
                </div>
                <div class = "product-div-right">
                    <span class = "product-name">Saridon</span>
                    ...
                    <p class = "product-description">Saridon Tablet 10's belongs to a class of painkillers called a non-steroidal anti-inflammatory drug (NSAIDs). Pain can be temporary (acute) or long-lasting (chronic) in nature. Acute pain is for a short time caused by damage to the tissues of the muscle, bone, or other organs. While, chronic pain lasts for a long duration and is caused due to pathologies like nerve damage, osteoarthritis etc.</p>
                    <br>
                    <p class = "product-description">
                        <ul class="product-description">
                        <h4>Contraindications of Saridon</h4>
                        
                        <li> If pregnant or nursing, consult with the doctor first before using.</li>
                        <li>Not for children below the age of 12</li>  
                    ...
                    <br>
                    <h4>Side effects of Refresh Eye Drop</h4>
                    <p class="product-description">
                        Nausea , Indigestion , Stomach pain , Restlessness
                    </p>
