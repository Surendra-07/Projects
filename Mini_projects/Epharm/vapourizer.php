            ...
            <div class = "product-div">
                <div class = "product-div-left">
                    <div class = "img-container">
                        <img src = "HEALTHCARE IMG\Vaporizer\pharmeasy-all-in-one-vaporizer-1-1654233812.webp" alt = "watch">
                    </div>
                    <div class = "hover-container">
                        
                        <div><img src = "HEALTHCARE IMG\Vaporizer\pharmeasy-all-in-one-vaporizer-1-1654233812.webp"></div>
                        <div><img src = "HEALTHCARE IMG\Vaporizer\pharmeasy-all-in-one-vaporizer-2-1654233960.webp"></div>
                        <div><img src = "HEALTHCARE IMG\Vaporizer\pharmeasy-all-in-one-vaporizer-3-1654233960.webp"></div>
                        <div><img src = "HEALTHCARE IMG\Vaporizer\pharmeasy-all-in-one-vaporizer-6.1-1654233944.webp"></div>
                        <div><img src = "HEALTHCARE IMG\Vaporizer\pharmeasy-all-in-one-vaporizer-3-1654233960.webp"></div>
                    </div>
                </div>
                <div class = "product-div-right">
                    <span class = "product-name">Vapourizer</span>
                    <span class = "product-price">₹ 269.25</span>
                    ...
                    <p class="product-description">
                        <span>Use the device indoors</span>
                        <span>If children are using it, make sure they do it under adult supervision</span>
                        <span>Keep the device standing straight while using it, to prevent spillage of hot water</span>
