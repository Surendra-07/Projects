            ...
            <div class = "product-div">
                <div class = "product-div-left">
                    <div class = "img-container">
                        <img src = "crosin\crocin-pain-relief-tablet.png" alt = "watch">
                    </div>
                    <div class = "hover-container">
                        
                        <div><img src = "crosin\onav4rssxbdwvk1pedey.webp"></div>
                        <div><img src = "crosin\f6ewpyttm6aat6oz08b9.webp"></div>
                        <div><img src = "crosin\xpbzv97jzad2x53a1orm.webp"></div>
                        <div><img src = "https://cdn01.pharmeasy.in/dam/products/269415/crocin-pain-relief-strip-of-15-tablets-2-1641536314.jpg"></div>
                        <div><img src = "https://cdn01.pharmeasy.in/dam/products/269415/crocin-pain-relief-strip-of-15-tablets-7-1641536316.jpg"></div>
                    </div>
                </div>
                <div class = "product-div-right">
                    <span class = "product-name">Crosin</span>
                    <span class = "product-price">₹ 59.25</span>
                    ...
                    <p class = "product-description">Crocin Advance Tablet helps relieve pain and fever by blocking the release of certain chemical messengers responsible for fever and pain.</p>
                    <br>
                    <p class = "product-description">
                        <ul class="product-description">
                        <h4>Contraindications of Crosin Strip Of 15 Tablets</h4>
                        
                        <li>If you are allergic to paracetamol or any of the ingredients of this medicine.</li>
                       <li>If you are taking any other medicine that contains paracetamol.</li> 
                    ...
                    <br>
                    <h4>Side effects of Combiflam Strip Of 20 Tablets</h4>
                    <p class="product-description">
                        Insomnia (difficulty in sleeping), Nervousness, Irritation, Restlessness
