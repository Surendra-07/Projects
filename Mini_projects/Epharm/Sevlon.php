            ...
            <div class = "product-div">
                <div class = "product-div-left">
                    <div class = "img-container">
                        <img src = "Sevlon\savlon-antiseptic-disinfectant-liquid-1000-ml-2-1658475751.webp" alt = "watch">
                    </div>
                    <div class = "hover-container">
                        <div><img src = "Sevlon\savlon-antiseptic-disinfectant-liquid-1000-ml-2-1658475751.webp"></div>
                        <div><img src = "Sevlon\savlon-antiseptic-liquid-bottle-of-200-ml-6.3-1660893013.webp"></div>
                        <div><img src = "Sevlon\savlon-antiseptic-liquid-bottle-of-200-ml-7-1660893010.webp"></div>
                        <div><img src = "https://www.bigbasket.com/media/uploads/p/l/40091676-5_1-savlon-antiseptic-disinfectant-liquid.jpg"></div>
                        <div><img src = "https://5.imimg.com/data5/SELLER/Default/2020/10/UA/SA/VR/86962497/savlon-antiseptic-liquid-500x500.jpeg"></div>
                    </div>
                </div>
                <div class = "product-div-right">
                    <span class = "product-name">Savlon</span>
                    ...
                    <p class = "product-description">Savlon Antiseptic Liquid is a strong germ-killing antiseptic for first-aid care at home. With a strong formula that includes Chlorhexidine Gluconate and Cetrimide, the Savlon Antiseptic provides effective sanitization treatment. It is extremely useful for cuts and bruises to protect you from bacteria and germs entering through openings in the skin. Alternatively, Savlon Antiseptic Liquid can be used as a disinfectant for laundry or bathing when it has been diluted properly.</p>
                    <br>
                    <p class = "product-description">
                        <ul class="product-description">
                        <h4>Contraindications of Savlon</h4>
                        
                        <li> Should not be administered to anyone with a potential history of an allergic reaction to a chlorhexidine-containing compound.</li>
                        <li>Cetostearyl Alcohol may cause local skin reactions.</li>  
                    ...
                    <br>
                    <h4>Side effects of Savlon</h4>
                    <p class="product-description">
                        When used as an antiseptic liquid as recommended, it does not cause any side effects. However, if used for cuts and wounds or as an after-shave lotion without diluting, it may cause mild irritation and sting on the skin but no major side effects.
                    </p>
