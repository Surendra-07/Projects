            ...
            <div class = "product-div">
                <div class = "product-div-left">
                    <div class = "img-container">
                        <img src = "https://5.imimg.com/data5/SELLER/Default/2022/5/EH/TK/DN/5816895/framycetin-soframycin-skin-cream-1000x1000.jpg" alt = "watch">
                    </div>
                    <div class = "hover-container">
                        <div><img src = "https://5.imimg.com/data5/SELLER/Default/2022/5/EH/TK/DN/5816895/framycetin-soframycin-skin-cream-1000x1000.jpg"></div>
                        <div><img src = "https://d1j4fphs4leb29.cloudfront.net/product_img/93046/211656-1.jpg"></div>
                        <div><img src = "https://www.tabletshablet.com/wp-content/uploads/2021/03/Soframycin-Skin-Cream-100gm.jpg"></div>
                        <div><img src = "https://meds.myupchar.com/43454/open-uri20220218-7111-1qafw86"></div>
                        <div><img src = "https://img.udaan.com/f_auto,q_auto:eco,w_800/u/products/06ggd2b8p11ydzcjq7us.448Z/Soframycin-30-gm-Cream---EACH-of-1"></div>
                    </div>
                </div>
                <div class = "product-div-right">
                    <span class = "product-name">Soframycin</span>
                    ...
                    <p class = "product-description">Soframycin skin cream is a topical antibiotic cream. It is used to treat various skin conditions caused by a bacterial infection associated with skin, hair, external ear and nail infections caused bybacteria and open wounds suspected to have a bacterial infection. The cream contains framycetin as its active ingredient that works by killing the bacteria responsible for the infection. Soframycin cream is meant only for external application and should be applied exactly as recommended by your doctor.</p>
                    <br>
                    <p class = "product-description">
                        <ul class="product-description">
                        <h4>Contraindications of Soframycin</h4>
                        
                        <li> If you are allergic to framycetin or any other components of Soframycin skin cream.</li>
                        <li>If you are pregnant or think you might be pregnant or trying to conceive.</li>  
                    ...
                    <br>
                    <h4>Side effects of Soframycin</h4>
                    <p class="product-description">
