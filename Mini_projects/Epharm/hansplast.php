            ...
            <div class = "product-div">
                <div class = "product-div-left">
                    <div class = "img-container">
                        <img src = "Personal Care\hansaplast\hansaplast-regular.webp" alt = "watch">
                    </div>
                    <div class = "hover-container">
                        <div><img src = "Personal Care\hansaplast\hansaplast-regular.webp"></div>
                        <div><img src = "https://onemg.gumlet.io/a_ignore,w_380,h_380,c_fit,q_auto,f_auto/zbclez9bbgjipvec8ska.jpg"></div>
                        <div><img src = "Personal Care\hansaplast\mipmonn7qzdgov83gvml.webp"></div>
                        <div><img src = "Personal Care\hansaplast\nessymqt0tzxave75p31.webp"></div>
                        <div><img src = "Personal Care\hansaplast\p1va0q0at6blmkka7ajc.webp"></div>
                    </div>
                </div>
                <div class = "product-div-right">
                    <span class = "product-name">Hansaplast Regular</span>
                    ...
                    <p class = "product-description">Hansaplast Regular Strip is a plastic plaster suitable for covering wounds and bruises.</p>
                    <br>
                    <p class = "product-description">
                        <ul class="product-description">
                        <h4>Contraindications of Hansaplast-regular</h4>
                        
                        <li> In individuals with hypersensitivity to the active substance, to other sources of capsaicinoids or to any of the excipients in the plaster , on damaged skin and wounds..</li>
                       <li>If in doubt or if symptoms persist, consult your doctor or pharmacist.</li> 
                    ...
                    <br>
                    <h4>Side effects of Hansaplast-regular</h4>
                    <p class="product-description">
                        When used as directed, Hansaplast Spot Bandage is generally safe and has no negative side effects.
                    </p>
