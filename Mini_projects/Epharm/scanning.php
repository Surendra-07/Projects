...
<div class="A" style="display: flex; flex-direction:row9">
    <div id="header">
        ...
        <div class="row1">
            <a class="headlink" href="home.php"  style="text-decoration:none;"><h3>Home</h3></a>
        </div>
        <div class="row1">
            <a class="headlink" href="aboutus.html"  style="text-decoration:none;"><h3>About Us</h3></a>
        </div>
        <div class="row1">
            <a class="headlink" href="service.html"  style="text-decoration:none;"><h3>Service</h3></a>
        </div>
        <div class="row1">
            <a class="headlink" href="contactus.html" style="text-decoration:none;"><h3>Contact us</h3></a>
        </div>
        <div class="row1">
           <a class="headlink" href="signup.php"  > 
            <center>
              <button class="glowing-button" style="margin-top:35px ;margin-left: 120px;">
            ...
            <div class = "product-div">
                <div class = "product-div-left">
                    <div class = "img-container">
                        <img src = "HEALTHCARE IMG/scanning Thermometer/pharmeasy-infrared-thermometer-2-1667628955.webp" alt = "watch">
                    </div>
                    <div class = "hover-container">
                        <div><img src = "HEALTHCARE IMG\scanning Thermometer\pharmeasy-infrared-thermometer-2-1667628955.webp"></div>
                        <div><img src = "HEALTHCARE IMG\scanning Thermometer\pharmeasy-infrared-thermometer-6.1-1667628955.webp"></div>
                        <div><img src = "HEALTHCARE IMG\scanning Thermometer\pharmeasy-infrared-thermometer-6.2-1667628941.webp"></div>
                        <div><img src = "HEALTHCARE IMG\scanning Thermometer\pharmeasy-infrared-thermometer-2-1667628955.webp"></div>
                        <div><img src = "HEALTHCARE IMG\scanning Thermometer\pharmeasy-infrared-thermometer-6.2-1667628941.webp"></div>
                    </div>
                </div>
                <div class = "product-div-right">
                    <span class = "product-name">Scanning Thermometer</span>
                    <span class = "product-price">₹ 999.25</span>
                    ...
                    <p class = "product-description">Leelvis non-contact infrared thermometer is designed for top-notch medical use. The thermometer is accurate and helps monitor the temperature of patients with ease. The Leelvis non-contact infrared thermometer is very quick and accurate in detecting high levels of body temperature if it is raised due to some reason.</p>
                    <br>
                    <p class = "product-description">
                        <ul class="product-description">
                        <h4>Benefits</h4>
                        
                        <li>The thermometer is non-contact and can instantly measure the temperature of a person from a distance by simply pointing towards the person and clicking a button.</li>
                       <li>The thermometer is a hassle-free device to measure the temperature of babies without disturbing them.

                    </li> 
                        <!-- <li>If you are taking medicines containing paracetamol or ibuprofen or other pain medicines.</li> -->
