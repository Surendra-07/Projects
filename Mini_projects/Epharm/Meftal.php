            ...
            <div class = "product-div">
                <div class = "product-div-left">
                    <div class = "img-container">
                        <img src = "Personal Care\Meftal Spas\meftal-spas-tablet-2-1641531171.webp" alt = "watch">
                    </div>
                    <div class = "hover-container">
                        <div><img src = "Personal Care\Meftal Spas\meftal-spas-tablet-2-1641531171.webp"></div>
                        <div><img src = "Personal Care\Meftal Spas\meftal-spas-tablet-7-1641531172.webp"></div>
                        <div><img src = "https://bizimages.withfloats.com/actual/5b39d004cdde790f4c10e705.jpg"></div>
                        <div><img src = "https://5.imimg.com/data5/SELLER/Default/2021/8/ZM/PK/AD/30403750/mefenamic-acid-dicyclomine-hydrochloride-tablets-500x500.jpg"></div>
                        <div><img src = "https://www.practostatic.com/practopedia-images/v3/res-750/meftal-spas-tablet-10-s_b734475b-4c83-4e6c-a651-739d6f8cf8b4.JPG"></div>
                    </div>
                </div>
                <div class = "product-div-right">
                    <span class = "product-name">Meftal-Spas Tablet</span>
                    ...
                    <p class = "product-description">Meftal Spas tablet is an antispasmodic medicine. It contains a combination of dicyclomine and mefenamic acid. This medicine is used for relieving pain and spasm in the abdomen and during or before meses (periods). Meftal Spas work by blocking the action of certain chemicals responsible for pain and relaxing the smooth muscles. The dose and duration of the Meftal Spas tablet are decided by your doctor..</p>
                    <br>
                    <p class = "product-description">
                        <ul class="product-description">
                        <h4>Contraindications of Meftal-Spas</h4>
                        
                        <li> If you are allergic to mefenamic acid, dicyclomine or any ingredient of the Meftal Spas tablet.</li>
                       <li>If you have inflammatory bowel disease, gastrointestinal bleeding or obstruction in the intestine.</li> 
                        <li>If you have severe kidney, liver or heart function problems.</li>
                    ...
                    <br>
                    <h4>Side effects of Meftal-Spas</h4>
                    <p class="product-description">
                        Nausea , Vomiting , Stomach upset , Dizziness , Drowsiness
                    </p>
